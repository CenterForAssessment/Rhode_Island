...
variables.to.keep <- c("SECONDARY_SCHOOL_STUDENT_ID", "STUDENT_FIRST_NAME", "STUDENT_LAST", "SEX", "DERIVED_AGGREGATE_RACE_ETHNICITY", "ACCOMMODATIONS_USED", # "COLLEGE_BOARD_STUDENT_ID",
        ...
        "DISTRICT_NAME", "STATE_ORGANIZATION_CODE", "RESPONSIBLE_ATTENDING_INSTITUTION_NAME", "RESPONSIBLE_ATTENDING_INSTITUTION_CODE") #, "LATEST_PSAT_DATE")
...
#  Rhode_Island_Data_PSAT_2018[INVALIDATED_SCORE == "Y", VALID_CASE := "INVALID_CASE"]


variable.names.new <- c("ID", "FIRST_NAME", "LAST_NAME", "GENDER", "ETHNICITY", "IEP_STATUS", # "CB_ID",
        "PSAT_TOTAL", "ELA_PSAT_10", "MATHEMATICS_PSAT_10", "COHORT_YEAR", "INVALIDATED_SCORE", "STUDENT_PARTICIPATED_INDICATOR",
        "DISTRICT_NAME", "DISTRICT_NUMBER", "SCHOOL_NAME", "SCHOOL_NUMBER", "VALID_CASE") # , "LATEST_PSAT_DATE")
