...
tmp.variables <- c("RPTSTUDID", "LNAME", "FNAME", "GRADE", "DISCODE", "SCHCODE", "SPRDISCODE", "SPRSCHCODE",
                   "GENDER", "RACE7", "LEP", "IEP", "SES", "REASCALEDSCORE", "REAAL", "MATSCALEDSCORE", "MATAL", "SENDDISCODE", 
...
Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS[Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS==" "] <- NA
Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS <- as.character(Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS)
Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS[!is.na(Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS)] <- 
	paste("IEP Exit Status:", Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS[!is.na(Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS)])
Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS <- factor(Rhode_Island_Data_LONG_2012_2013$IEP_EXIT_STATUS)
...
Rhode_Island_Data_LONG_2012_2013[['SCHOOL_NUMBER']][is.na(Rhode_Island_Data_LONG_2012_2013[['SCHOOL_NUMBER']]) & Rhode_Island_Data_LONG_2012_2013[['YEAR']]=="2012_2013"] <- "88888"
...
Rhode_Island_Data_LONG_2012_2013 <- Rhode_Island_Data_LONG_2012_2013[,c(names(sort(sapply(names(Rhode_Island_Data_LONG_2012_2013), function(x) match(x, names(Rhode_Island_SGP@Data))))), "IEP_EXIT_STATUS")]
