...
Rhode_Island_Data_PSAT_2019<- Rhode_Island_Data_PSAT_2019[, variables.to.keep, with=FALSE][, GRADE_ENROLLED := "10"]
Rhode_Island_Data_SAT_2019 <- Rhode_Island_Data_SAT_2019[, variables.to.keep, with=FALSE][, GRADE_ENROLLED := "11"]
...
variable.names.new <- c("ID", "FIRST_NAME", "LAST_NAME", "GENDER", "ETHNICITY", "IEP_STATUS",
        ...
        "DISTRICT_NUMBER", "DISTRICT_NAME", "SCHOOL_NUMBER", "SCHOOL_NAME", "FORM_CODE", "participant_ela", "participant_math", "GRADE_ENROLLED")
...
final.vars.to.keep <- c("ID", "YEAR", "GRADE", "GRADE_ENROLLED", "FIRST_NAME", "LAST_NAME", "DISTRICT_NUMBER", "DISTRICT_NAME", "SCHOOL_NUMBER", "SCHOOL_NAME",
                        "GENDER", "ETHNICITY", "SCALE_SCORE", "participant_ela", "participant_math", "FORM_CODE")
...
###   Load data
Rhode_Island_Data_LONG_RICAS_2018_2019 <- fread("Data/Base_Files/RICAS2019-PRE-DISCREPANCY-MegaFile-2019-08-08.csv", stringsAsFactors=FALSE)
...
Rhode_Island_Data_LONG_RICAS_2018_2019[DISTRICT_NUMBER=="D23334", VALID_CASE:="INVALID_CASE"]
...
# dups <- Rhode_Island_Data_LONG_RICAS_2018_2019[VALID_CASE=="VALID_CASE"][c(which(duplicated(Rhode_Island_Data_LONG_RICAS_2018_2019[VALID_CASE=="VALID_CASE"], by=key(Rhode_Island_Data_LONG_RICAS_2018_2019)))-1, which(duplicated(Rhode_Island_Data_LONG_RICAS_2018_2019[VALID_CASE=="VALID_CASE"], by=key(Rhode_Island_Data_LONG_RICAS_2018_2019)))),]
# setkeyv(dups, key(Rhode_Island_Data_LONG_RICAS_2018_2019))  #  0 duplicate cases RICAS data 8/8/19
...
Rhode_Island_Data_LONG_2018_2019 <- rbindlist(list(Rhode_Island_Data_LONG_SAT_2018_2019, Rhode_Island_Data_LONG_RICAS_2018_2019), fill=TRUE)
