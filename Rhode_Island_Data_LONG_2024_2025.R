####################################################################
###                                                              ###
###   Script for creating Rhode Island LONG Data for 2024_2025   ###
###                                                              ###
####################################################################
...
###   Load Data
Rhode_Island_Data_LONG_PSAT_2024_2025 <- fread("Data/Base_Files/RI_STATE_ACCT_RPT_PSAT10_06042024.csv", fill=TRUE, sep=",")
Rhode_Island_Data_LONG_SAT_2024_2025 <- fread("Data/Base_Files/RI_STATE_ACCT_RPT_SAT_06042024.csv", fill=TRUE, sep=",")
...
setnames(Rhode_Island_Data_LONG_PSAT_SAT_2024_2025, "FORM_CODE", 'FORM')
...
setattr(Rhode_Island_Data_LONG_PSAT_SAT_2024_2025$SEX, "levels", c("Female", "Male", "Other"))
