...
levels(Rhode_Island_Data_LONG_RICAS_2024_2025$TEST_FORMAT) <- c("Online", "Paper")
Rhode_Island_Data_LONG_RICAS_2024_2025[, TEST_FORMAT := as.character(TEST_FORMAT)]
levels(Rhode_Island_Data_LONG_RICAS_2024_2025$EMH_LEVEL) <- c("Elementary", "Elementary/Middle", "High", "Middle", "PK-12")
